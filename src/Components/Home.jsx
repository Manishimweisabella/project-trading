...
const Home = () => {
  return (
    <div>
      ...
      <div className="bg-gray-50 bg-opacity-90 rounded-2xl p-6 shadow-lg w-11/12 mx-auto my-10 text-center">
        <h2 className="font-bold text-2xl mb-4 text-gray-800">my Target </h2>
